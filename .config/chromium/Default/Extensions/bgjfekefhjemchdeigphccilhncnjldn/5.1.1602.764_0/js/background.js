...
chrome.runtime.onMessage.addListener(function(message,sender,sendResponse) {
	...
	if(message.type=="opt_getconf"){
		sendResponse({type:message.type,defaultConf:defaultConf,devMode:devMode,config:config,os:_OS});
		return;
	}
	if(message.type=="evt_getconf"||message.type=="pop_getconf"){
		var _conf={};
			_conf.config=config;
			_conf.os=_OS;
