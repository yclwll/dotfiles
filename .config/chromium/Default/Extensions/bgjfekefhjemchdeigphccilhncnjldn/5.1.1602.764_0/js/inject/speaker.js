	...
	initUI:function(){
		...
		dom.innerHTML=
			'<div class="su_box_head" style="">'
				+'<span class="su_box_title">'+sue.apps.i18n("speaker")+'</span>'
			...
			+'<div class="su_box_main">'
				...
				+'<div class="su_box_opt">'
					+'<label class="su_box_opt_labelname">'+sue.apps.i18n("n_voicename")+'</label><select name="n_voicename" class="su_box_opt_select"><option value="s_unpin">'+sue.apps.i18n("s_unpin")+'</option><option value="s_pinned">'+sue.apps.i18n("s_pinned")+'</option></select><br />'
					+'<label class="su_box_opt_labelname">'+sue.apps.i18n("n_gender")+'</label><select name="n_gender" class="su_box_opt_select"><option value="s_female">'+sue.apps.i18n("s_female")+'</option><option value="s_male">'+sue.apps.i18n("s_male")+'</option></select><br />'
					+'<label class="su_box_opt_labelname">'+sue.apps.i18n("n_rate")+'</label><input name="n_rate" class="su_box_opt_range" min=".1" max="10" step=".1" type="range"><span class="su_box_opt_rangebox"></span><br />'
					+'<label class="su_box_opt_labelname">'+sue.apps.i18n("n_pitch")+'</label><input name="n_pitch" class="su_box_opt_range" min=".1" max="2" step=".1" type="range"><span class="su_box_opt_rangebox"></span><br />'
					+'<label class="su_box_opt_labelname">'+sue.apps.i18n("n_volume")+'</label><input name="n_volume" class="su_box_opt_range" min=".1" max="1" step=".1" type="range"><span class="su_box_opt_rangebox"></span><br />'
			...
			+'</div>';
		var voicedom=dom.querySelector(".su_box_opt select[name=n_voicename]");
		var _options;
