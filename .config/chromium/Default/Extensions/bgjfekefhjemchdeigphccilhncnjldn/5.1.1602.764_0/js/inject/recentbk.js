	...
	initUI:function(){
		...
		dom.innerHTML=
			'<div class="su_box_head" style="">'
				+'<span class="su_box_title">'+sue.apps.i18n("recentbk")+'</span>'
			...
			+'<div class="su_box_main">'
				...
				+'<div class="su_box_opt">'
					...
					+'<label class="su_box_opt_labelname">'+sue.apps.i18n("app_recentbk_recentlength")+'</label>'+'<input class="su_box_opt_range" name="n_num" min="5" max="50" type="range"><span class="su_box_opt_rangebox"></span><br />'
...
chrome.runtime.sendMessage({type:"apps_getvalue",apptype:"recentbk"},function(response){
	...
	//sue.apps.recentbk.zoom=response.value.zoom;
